...
const createHtmlProductEl = (productData) => {
    ...
    const template = `
        <div class="product">
            ...
            <img src="https://www.buyqualityplr.com/wp-content/uploads/edd/2017/12/Good-Ecommerce.png" width=200 height=200  alt=""/>
...
checkoutFormEl.addEventListener("submit", (event) => {
    ...
    acceptOffer(acceptOfferRequest)
        .then(reservationDetails => {
            reservationDetails.paymentUrl = undefined;
